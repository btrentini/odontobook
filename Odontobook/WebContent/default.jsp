<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
		<script src="${pageContext.request.contextPath}/jquery-1.3.2.min.js"></script>
		<script src="${pageContext.request.contextPath}/script.js"></script>
		<script src="${pageContext.request.contextPath}/jquery.validate.js"></script>
<c:set var="usuario" value="${login}"/>
	<c:if test="${usuario != null || not empty usuario }">
		<c:redirect url="/jsp/userOk.jsp"/>
</c:if>		
...
<!-- SCRIPTS -->
    ...
    <!--[if IE 8]><link rel="stylesheet" href="$${pageContext.request.contextPath}/style.ie7.css" type="text/css" media="screen" /><![endif]-->
...
<div id="principal">
	<form method="post" id="Form" action="login.ctrl">
			<h1> Login: </h1>
			<p> Usuário: <input type="text"     id="nome"  name="login"  class="areas" MAXLENGTH="16"    value=""/>  </p>
			<p> Senha:   <input type="password" id="senha" name="senha" class="areas"  MAXLENGTH="16"/> </p>
			<!--   <p> <span  style="cursor: pointer;" onClick="window.open('${pageContext.request.contextPath}/jsp/esqueciSenha.jsp','mywindow','width=250,height=10')"> <font size="0.5" color="blue"> <u><i>Esqueci minha senha!</i></u></font> <br></br> </span></p>--> 
			<p><INPUT TYPE="submit" name="acao" value="Acesso" class="art-button" id="botaoLogin" CHECKED/> </p>	
		
	</form>
	<p> ${resultado}</p> 
	<center><p><a href="${pageContext.request.contextPath}/jsp/newUser.jsp" >Novo Usuário?</a> </p> </center>
</div>
