...
<h1> Lista de Tratamentos de <font color="#000000">${sessionScope.login}</font>:  </h1> 
	...
	<table class="tabelas">
		<tr class="tituloTabela"  height="30">
			<td width="200px"> <center> PACIENTE / DENTISTA </center> </td>
			<td width="200px"> <center> dataProcedimento </center> </td>
			<td width="200px" > <center> numeroProcedimento </center></td>
			<td width="200px" > <center> observacoesProcedimento </center></td>
			<td width="200px" > <center> queixaPrincipalProcedimento </center></td>		
			<td width="200px" > <center> terminouUltimoTratamento </center></td>	
			<td width="200px" > <center> pressaoArterial </center></td>	
			<td width="200px" > <center> medicamentoUtilizando </center></td>	
			<td width="200px" > <center> statusProcedimento </center></td>	
			<td width="200px" > <center> Visualizar Anamnese Clinica </center></td>		
		</tr>
		
			<tr>
			<!--<c:forEach var="paciente" items="${sessionScope.pacientes}">		<!--</c:forEach>-->
				<td><center><!--${paciente.nome}--> paciente.nome</center></td>
				<td><center>  Visualizar </center></td>
				<td><center> Editar </center></td>
				<td><center><a href="removerTratamento.ctrl"> <img src="${pageContext.request.contextPath}/img/icon-trash.gif" > </a> </center> </img></td>
			</tr>
		...
		<!--   <tr>
			...
			<td> LINK </td>
			<td> LINK </td>
			<td> <center><a href="removerPaciente.ctrl"> <img src="${pageContext.request.contextPath}/img/icon-trash.gif" > </a> </center> </img> </td>
		</tr>-->
	</table>
