...
<!-- ============================================================================================================ -->
  ...
  <c:set var="teste" value="${sessionScope.permissoesDentistas}"/>
<br></br>
	<table class="tabelas">
		<tr class="tituloTabela"  height="30">
			<td width="200px"> <center>  Paciente </center> </td>
			<td width="200px"> <center>  CPF </center> </td>
			<td width="200px"> <center>  Prognostico </center></td>
			<td width="200px"> <center>  Anamnese </center></td>
		</tr>
		<c:if test="${teste == null || empty teste }">
	
       <td colspan="4" width="200px"> <center>  <h3> <font color="red"> Você ainda não tem pacientes... </font></h3> </center></td>	
		</c:if>
		...
		<c:forEach var="permissao" items="${sessionScope.permissoesDentistas}">	
			...
			<tr>
				<td><center>  ${ permissao.paciente.pessoa.login}</center></td>
				<td> ${ permissao.paciente.cpfPaciente}  </td>
			
				<td> 
				<form method="get" id="customForm" action="exibirPrognostico.ctrl">	
				
					<input type="text" id="exibirAnamnese" name="exibirPrognostico" hidden  value="${ permissao.paciente.pessoa.login}" />
				
					<INPUT TYPE="submit" name="acao"  class="botaoPrognostico"  value=""/>
				</form>
				</td>
				
			
				<td>
				<form method="get" id="customForm" action="visualizarAnamneseDoCara.ctrl">	
				
					<input type="text" id="exibirAnamnese" name="exibirAnamnese" hidden  value="${ permissao.paciente.pessoa.login}" />
				
					<INPUT TYPE="submit" name="acao"  class="botaoAnamnese" value="" />
				</form>
				 </td>
				</tr>
	</c:forEach>	
